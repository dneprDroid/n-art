...
{
  return [[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:frameworkName] stringByAppendingPathComponent:@""];
}
...
- (void)initialize
{
  ...
  NSString *frameworkResourcesPath = [self bundleResourcesPathForFrameworkName:@"lua"];
//    NSLog(@"torch path: %@,  %@", frameworkResourcesPath, [[NSBundle mainBundle] pathForResource:@"lua" ofType: nil]);
