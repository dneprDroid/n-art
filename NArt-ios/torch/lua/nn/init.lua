...
torch.include('nn','TanhShrink.lua')
...
torch.include('nn','SpatialFullConvolution.lua')
torch.include('nn','SpatialFullConvolutionMap.lua')
torch.include('nn','SpatialConvolutionMM.lua')
...
torch.include('nn','L1Cost.lua')
torch.include('nn','WeightedMSECriterion.lua')
...
--torch.include('nn','THNN')
torch.include('nn','SpatialReflectionPadding.lua')
torch.include('nn','SpatialBatchNormalization.lua')
torch.include('nn','MulConstant.lua')
